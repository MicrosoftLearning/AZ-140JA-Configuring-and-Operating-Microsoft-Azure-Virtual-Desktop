...
2. 「リモート デスクトップ」ウィンドウで、右上隅の省略記号アイコンをクリックし、ドロップダウン メニューで「**購読解除**」をクリックし、確認を求められたら、「**続行**」をクリックします。
3. **az140-cl-vm11** へのリモート デスクトップ セッション内の「リモート デスクトップ」ウィンドウの「**はじめに**」ページで、「**購読**」をクリックします。
