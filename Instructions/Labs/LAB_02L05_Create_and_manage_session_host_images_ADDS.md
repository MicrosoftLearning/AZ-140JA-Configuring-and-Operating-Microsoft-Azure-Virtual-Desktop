...
1. **「イメージの作成」** ブレードの **「基本」** タブで、次の設定を指定します。
   ...
   |ターゲット イメージ ギャラリー|新しいイメージ ギャラリーの名前 **az14025imagegallery**|
...
1. ラボ コンピューターから、Azure portal を表示している Web ブラウザーで、**共有イメージ ギャラリー**を検索して選択し、**共有イメージ ギャラリー** ブレードで **az14025imagegallery** エントリを選択し、****az14025imagegallery****ブレード で新しく作成されたイメージを表す **az140-25-host-image** エントリの存在を確認します。
