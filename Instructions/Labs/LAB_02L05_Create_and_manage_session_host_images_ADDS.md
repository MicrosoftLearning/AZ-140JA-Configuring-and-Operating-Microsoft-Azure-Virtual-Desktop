...
1. **az140-dc-vm0** ブレードで、「**接続**」を選択し、ドロップダウン メニューで、「**Bastion**」を選択し、「**az140-dc-vm0 \| 接続**」ブレードの Bastion タブで、「**Bastion の使用**」を選択します。
...
1. ラボ コンピューターの Azure portal を表示している Web ブラウザーで、**Azure cコンピューティング ギャラリー**を検索して選択し、**Azure コンピューティング ギャラリー** ブレードで、**az14025imagegallery** エントリを選択し、****az14025imagegallery**** ブレードで、新しく作成されたイメージを表す **az140-25-host-image** エントリが存在していることを確認します。
