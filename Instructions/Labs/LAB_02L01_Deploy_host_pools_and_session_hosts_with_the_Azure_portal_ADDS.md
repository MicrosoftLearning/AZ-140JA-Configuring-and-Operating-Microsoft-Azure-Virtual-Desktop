...
### 演習 1Azure AD DS ドメインで Azure Virtual Desktop 環境を実装する
...
1. **「仮想マシンをホスト プール ブレードに追加」** ブレードの **「Virtual Machines」** タブで、次の設定を指定し、**「Review + create」** を選択します (他は既定値のままにします)。
...
### 演習 2Azure Virtual Desktop 環境を検証する
